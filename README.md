...
```bash
oc -n <namespace-dev|test|prod> new-app --file=./ci/openshift/postgresql.dc.yaml 
```
...
```bash
oc -n <namespace-dev|test|prod> new-app --file=./ci/openshift/limesurvey-bcgov.dc.yaml 
```
