...
- the [oc](https://docs.openshift.com/container-platform/4.9/cli_reference/openshift_cli/getting-started-cli.html) CLI tool, installed on your local workstation
...
- the [oc](https://docs.openshift.com/container-platform/4.9/cli_reference/openshift_cli/getting-started-cli.html#cli-getting-started) CLI tool, installed on your local workstation
- access to this public [GitHub Repo](./)
...
```bash
oc -n <namespace-dev|test|prod> new-app --file=./ci/openshift/postgresql.dc.yaml -p TAG_NAME=<dev|test|prod>
```
...
```bash
oc -n <namespace-dev|test|prod> new-app --file=./ci/openshift/limesurvey-bcgov.dc.yaml -p TAG_NAME=<dev|test|prod>
```
